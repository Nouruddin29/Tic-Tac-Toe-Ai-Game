...
int main() {
    ...
    char player = 'X';
    cout<<"                     { TIC TAC TOE AI (minimax) } "<<"\n";
    cout<<"               $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<"\n\n";
    cout<<"First player (human) == x"<<"\n"<<"Second player (Computer) == O"<<"\n\n";
    cout<<"$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<"\n";
    cout<<"Enter position : row index then col index "<<"\n";
    cout<<"$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<"\n";
 ...
 while(!has_winner) {
   ...
   int result = checkWinner(board);
    if(result == 0) {
    	...
    	cout<<"######################################################################## \n";
        cout <<"FINISH ---> player "<< ((result == 2) ? "X" : "O") << "  wins \n";
    }
    return 0;
}
